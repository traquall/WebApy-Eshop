...
<form class="form-horizontal" action="?page=admin&crud=user&action=update&id=<?php echo $user->getId(); ?>" method="POST">
    ...
    <div class="form-group">
     ...
     <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="password" class="form-control" name="apassword"   placeholder="Ancien mot de passe">
        </div>
    </div>
    <div class="form-group">
