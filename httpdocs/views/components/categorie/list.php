   ...
   <td><?php echo $menu[$i]["nom"]; ?></td> 
       ...
       {echo"Français";
        ...
        echo"Anglais";
           ...
           <td>
      <a class="btn btn-success" href="?page=admin&crud=document&action=list&id=<?php echo $menu[$i]['id']; ?>"><i class="glyphicon glyphicon-folder-open
"></i> </a>
   ...
   <a class="btn btn-info" href="?page=admin&crud=categorie&action=read&id=<?php echo $menu[$i]['id']; ?>"><i class="fa fa-eye"></i> </a>
               ...
               <a class="btn btn-danger" onclick="if(!confirm('Voulez-vous vraiment supprimer la page : <?php echo $menu[$i]['nom']; ?> ?')){ return false; }"href="?page=admin&crud=categorie&action=delete&id=<?php echo $menu[$i]['id']; ?>">
       ...
       {echo"Français";
        ...
        echo"Anglais";
           ...
           <td> </td>
           <td>
            <a class="btn btn-success" href="?page=admin&crud=document&action=list&id=<?php echo $menu[$i]["enfants"][$j]['id']; ?>"><i class="glyphicon glyphicon-folder-open
"></i> </a>
              ...
              <a class="btn btn-danger" onclick="if(!confirm('Voulez-vous vraiment supprimer la page : <?php echo $menu[$i]["enfants"][$j]['nom']; ?> ?')){ return false; }"href="?page=admin&crud=categorie&action=delete&id=<?php echo $menu[$i]["enfants"][$j]['id'] ?>"><i class="glyphicon glyphicon-trash
  "></i> </a>
           </td>
            </tr>
                ...
                <td style="padding: 8px 0 0 50px;">
                   * <?php echo $menu[$i]["enfants"][$j]["enfants"][$k]["nom"]; ?>
                   </td> 
                    <!--<td><?php if($menu[$i]["id_lang"]==1)
           {echo"Français";
           }else{
            echo"Anglais";
               ...
               <td> </td>
               <td>
                <a class="btn btn-success" href="?page=admin&crud=document&action=list&id=<?php echo $menu[$i]["enfants"][$j]["enfants"][$k]['id']; ?>"><i class="glyphicon glyphicon-folder-open
"></i> </a>
                  ...
                  <a class="btn btn-danger" onclick="if(!confirm('Voulez-vous vraiment supprimer la page : <?php echo $menu[$i]["enfants"][$j]["enfants"][$k]['nom']; ?> ?')){ return false; }"href="?page=admin&crud=categorie&action=delete&id=<?php echo $menu[$i]["enfants"][$j]["enfants"][$k]['id'] ?>"><i class="glyphicon glyphicon-trash
      "></i> </a>
               </td>
                </tr>
                    <?php for($l=0;$l<count($menu[$i]["enfants"][$j]["enfants"][$k]["enfants"]);$l++) { ?>
                    <tr>
                    <td style="padding: 8px 0 0 75px;">
                       + <?php echo $menu[$i]["enfants"][$j]["enfants"][$k]["enfants"][$l]["nom"]; ?>
                       </td> 
                        <!--<td><?php if($menu[$i]["id_lang"]==1)
               {echo"Français";
               }else{
                echo"Anglais";
                   ...
                   <td> </td>
                   <td>
                    <a class="btn btn-success" href="?page=admin&crud=document&action=list&id=<?php echo $menu[$i]["enfants"][$j]["enfants"][$k]["enfants"][$l]['id'];?>"><i class="glyphicon glyphicon-folder-open
"></i> </a>
                      ...
                      <a class="btn btn-danger" onclick="if(!confirm('Voulez-vous vraiment supprimer la page : <?php echo $menu[$i]["enfants"][$j]["enfants"][$k]["enfants"][$l]['nom']; ?> ?')){ return false; }"href="?page=admin&crud=categorie&action=delete&id=<?php echo $menu[$i]["enfants"][$j]["enfants"][$k]["enfants"][$l]['id'] ?>"><i class="glyphicon glyphicon-trash
          "></i> </a>
                   </td>
                    </tr>
